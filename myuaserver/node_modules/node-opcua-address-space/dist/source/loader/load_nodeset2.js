...
function makeStructureDefinition(definitionFields) {
    // Structure = 0,
    // StructureWithOptionalFields = 1,
    // Union = 2,
    return new node_opcua_types_1.StructureDefinition({
            ...
            const processBasicDataType = (addressSpace2) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (definitionFields.length) {
                    ...
                    if (isStructure /*&& dataTypeNode.nodeId.namespace !== 0*/) {
                        ...
                        dataTypeNode.$definition = makeStructureDefinition(definitionFields);
                    }

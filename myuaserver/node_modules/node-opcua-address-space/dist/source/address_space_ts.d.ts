...
export declare type StatusCodeCallback = (err: Error | null, statusCode?: StatusCode) => void;
...
export declare type BindVariableOptions = {
    historyRead?: any;
} | BindVariableOptionsVariation1 | BindVariableOptionsVariation2 | BindVariableOptionsVariation3;
...
export interface UAVariable extends BaseNode, VariableAttributes, IPropertyAndComponentHolder {
    ...
    historyRead(context: SessionContext, historyReadDetails: HistoryReadDetails, indexRange: NumericRange | null, dataEncoding: QualifiedNameLike | null, continuationPoint: ContinuationPoint | null, callback: Callback<HistoryReadResult>): void;
...
export declare type PseudoVariant = PseudoVariantNull | PseudoVariantString | PseudoVariantBoolean | PseudoVariantNodeId | PseudoVariantDateTime | PseudoVariantByteString | PseudoVariantDuration | PseudoVariantLocalizedText | PseudoVariantStatusCode | PseudoVariantUInt32 | PseudoVariantExtensionObject | PseudoVariantExtensionObjectArray;
...
export declare type ModellingRuleType = "Mandatory" | "Optional" | null;

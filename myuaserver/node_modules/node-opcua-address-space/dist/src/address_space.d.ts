...
import { AddReferenceOpts, AddressSpace as AddressSpacePublic, IEventData, IHistoricalDataNodeOptions, RootFolder, SessionContext, UAEventType, UAEventType as UAEventTypePublic, UAObjectType as UAObjectTypePublic, UAVariableType as UAVariableTypePublic } from "../source";
...
export declare class AddressSpace implements AddressSpacePrivate {
    ...
    constructEventData(eventTypeId: UAEventTypePublic, data: any): IEventData;
    /**
     * browse some path.
     *
     * @method browsePath

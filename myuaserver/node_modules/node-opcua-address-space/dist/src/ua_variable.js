...
function validateDataType(addressSpace, dataTypeNodeId, variantDataType, nodeId) {
    ...
    if (destUADataType.isAbstract || destUADataType.nodeId.namespace !== 0) {
        ...
        builtInType = node_opcua_factory_1.findBuiltInType(destUADataType.symbolicName).name;
    ...
    bindExtensionObject(optionalExtensionObject) {
        ...
        for (const field of (definition === null || definition === void 0 ? void 0 : definition.fields) || []) {
            ...
            if (doDebug) {
                ...
                debugLog(chalk.cyan("xxx"), " dataType", w(field.dataType.toString(), 8), w(field.name, 35), "valueRank", chalk.cyan(w(field.valueRank.toString(), 3)), chalk.green(w(x, 25)), "basicType = ", chalk.yellow(w(basicType.toString(), 20)), property.nodeId.toString(), property.readValue().statusCode.toString());
            }

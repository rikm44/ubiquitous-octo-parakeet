...
class OPCUAServer extends base_server_1.OPCUABaseServer {
    ...
    _on_CreateSessionRequest(message, channel) {
        ...
        if (node_opcua_secure_channel_1.nonceAlreadyBeenUsed(request.clientNonce)) {
            errorLog(chalk.red("SERVER with secure connection: Nonee has already been used"), request.clientNonce && request.clientNonce.toString("hex"));
            return rejectConnection(node_opcua_status_code_1.StatusCodes.BadNonceInvalid);
        }
    ...
    _on_ActivateSessionRequest(message, channel) {
        ...
        if (session.status === "active") {
            ...
            warningLog(chalk.yellow.bold(" Bad Session Closed in  _on_ActivateSessionRequest"), authenticationToken.value.toString("hex"));
            return rejectConnection(node_opcua_status_code_1.StatusCodes.BadSessionClosed);
        }

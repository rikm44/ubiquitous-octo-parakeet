...
class ServerEngine extends events_1.EventEmitter {
    ...
    initialize(options, callback) {
        ...
        node_opcua_address_space_1.generateAddressSpace(engine.addressSpace, options.nodeset_filename, () => {
                ...
                function fix_ProgramStateMachineType_ProgramDiagnostics() {
                    ...
                    if (variable) {
                        variable.setValueFromSource({
                            ...
                            value: new node_opcua_types_1.ProgramDiagnostic2DataType()
                        });
                    }
                }
            ...
            function prepareServerDiagnostics() {
                ...
                // component
                const samplingIntervalDiagnosticsArray = serverDiagnostics.getComponentByName("SamplingIntervalDiagnosticsArray");
    ...
    createSession(options) {
        ...
        session.on("timeout", () => {
            ...
            console.log(chalk.cyan("Server: closing SESSION "), session.status, chalk.yellow(session.sessionName), chalk.yellow(session.nodeId.toString()), chalk.cyan(" because of timeout = "), session.sessionTimeout, chalk.cyan(" has expired without a keep alive"));

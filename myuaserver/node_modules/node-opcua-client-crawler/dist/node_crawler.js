...
function getReferenceTypeId(referenceType) {
    ...
    else if (referenceType.toString() === node_opcua_nodeid_1.NodeId.resolveNodeId("HasDescription").toString() || referenceType === "HasDescription") {
...
class NodeCrawler extends events_1.EventEmitter {
    ...
    dispose() {
        ...
        node_opcua_assert_1.assert(this.pendingBrowseNextTasks.length === 0);
        /*
                this.session = null;
        ...
        */
        ...
        node_opcua_assert_1.assert(this.taskQueue.length() === 0);
        ...
        async.parallel({
            ...
            task5_variable_dataValue: (callback) => {
                ...
                this._defer_readNode(cacheNode.nodeId, node_opcua_data_model_1.AttributeIds.Value, (err, value) => {
                    if (!err) {
                        node_opcua_assert_1.assert(value instanceof node_opcua_data_value_1.DataValue);
